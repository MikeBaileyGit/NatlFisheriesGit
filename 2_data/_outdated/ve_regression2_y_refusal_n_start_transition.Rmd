...
```{r}
## Dummy Variable if month year is in or after March 2016
monthly$USDA01 = ifelse(((monthly$year == 2016 & (monthly$month == "03" | monthly$month == "04" | monthly$month == "05" | monthly$month == "06" | monthly$month == "07" | monthly$month == "08" | monthly$month == "09" | monthly$month == "10" | monthly$month == "11" | monthly$month == "12")) 
                         | monthly$year >= 2017), 1, 0)
